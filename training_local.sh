...
python src/train/train.py --config-path ./configs/vimeo_img2img/local_v15.yaml ---resume-path ckpt/vimeo_img2img/init_local.ckpt ---gpus 8 ---logdir logs/vimeo_img2img/local/
